...
public class ClienteController {
    ...
    @GetMapping("/{id}")
    public ResponseEntity<ClienteResponse> trovaPerId(@PathVariable Long id) {
        return ResponseEntity.ok(clienteService.trovaPerId(id));
    }
    ...
    public ResponseEntity<ClienteResponse> aggiornaCliente(
        ...
        return ResponseEntity.ok(
                clienteService.modificaCliente(id, clienteRequest));
    }
    ...
    public ResponseEntity<ClienteDettaglioResponse> dettaglio(@PathVariable Long id) {
        return ResponseEntity.ok(clienteService.trovaClienteConOrdini(id));
    }

    @GetMapping("/con-ordini")
    public ResponseEntity<List<ClienteResponse>> trovaTuttiConOrdini() {
        return ResponseEntity.ok(clienteService.trovaTuttiConOrdini());
    }
}
